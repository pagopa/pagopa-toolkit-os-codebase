...
public class DebtPositionGenerationTest {
	...
	String email = "paolo.rossi@gmail.it";
	...
	Date expirationDate = new GregorianCalendar(2022, Calendar.OCTOBER, 03).getTime();
	String specificCollectionData = "specific collection data";
	...
	public void testGenerate() throws Exception {
		...
		DPPaymentDetail paymentDetail = DebtPositionGeneration.generatePaymentDetail(domainIdentifier, auxDigit,
				...
				specificCollectionData, documentNumber, installmentNumber);
	 ...
	 */
	@Test
	public void testTypeUniqueIdentifierLength() {
		if (typeUniqueIdentifier != null) {
			assertTrue(typeUniqueIdentifier.length() == 1);
		}
	}
