...
/**
 * Tests on generation of <code>Rpt</code>
 */
public class RptGenerationTest {
    ...
    /**
     * Test method on generation of <code>Rpt</code> with all fields valued
     * starting from the single data
     * 
     * @throws Exception
     * @see RptContainer
     * @see RptGeneration
    ...
    /**
     * Test method on generation of <code>Rpt</code> with only mandatory fields
     * valued starting from the single data
     * 
     * @throws Exception
     * @see RptContainer
     * @see RptGeneration
    ...
    /**
     * Test method on generation of <code>Rpt</code> with only mandatory fields
     * valued starting from <code>DebtPosition</code>
     * 
     * @throws Exception
     * @see DebtPosition
