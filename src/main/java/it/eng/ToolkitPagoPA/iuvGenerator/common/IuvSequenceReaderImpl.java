package it.eng.ToolkitPagoPA.iuvGenerator.common;
...
import it.eng.ToolkitPagoPA.iuvGenerator.exception.UnexpectedValueException;
...
public class IuvSequenceReaderImpl implements IuvSequenceReader {
	...
	public String next() {
		...
		if (!pattern.matcher(sequence).matches()) {
			throw new UnexpectedValueException("Unexpected generated value: " + sequence);
		}
