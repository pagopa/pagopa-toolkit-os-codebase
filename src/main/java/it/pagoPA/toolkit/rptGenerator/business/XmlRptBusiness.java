...
import it.pagoPA.toolkit.rptGenerator.exception.XmlRptGeneratorException;
import it.pagoPA.toolkit.rptGenerator.xsd.CtDatiMarcaBolloDigitale;
import it.pagoPA.toolkit.rptGenerator.xsd.CtDatiSingoloVersamentoRPT;
import it.pagoPA.toolkit.rptGenerator.xsd.CtDatiVersamentoRPT;
import it.pagoPA.toolkit.rptGenerator.xsd.CtDominio;
import it.pagoPA.toolkit.rptGenerator.xsd.CtEnteBeneficiario;
import it.pagoPA.toolkit.rptGenerator.xsd.CtIdentificativoUnivocoPersonaFG;
import it.pagoPA.toolkit.rptGenerator.xsd.CtIdentificativoUnivocoPersonaG;
import it.pagoPA.toolkit.rptGenerator.xsd.CtRichiestaPagamentoTelematico;
import it.pagoPA.toolkit.rptGenerator.xsd.CtSoggettoPagatore;
import it.pagoPA.toolkit.rptGenerator.xsd.CtSoggettoVersante;
...
public class XmlRptBusiness {
    ...
    public static void generateRptXml(RptContainer rptContainer) throws Exception {
        ...
        try {
            ...
            rptContainer.setRptXml(xmlRptGeneration(ctRichiestaPagamentoTelematico));
    ...
    /**
     * Generate byteArray XML RPT
     * 
     * @param ctRichiestaPagamentoTelematico
     * @return
