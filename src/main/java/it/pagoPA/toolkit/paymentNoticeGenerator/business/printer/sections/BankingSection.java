...
import it.pagoPA.toolkit.paymentNoticeGenerator.business.printer.QrCodeBusiness;
...
public class BankingSection {
	...
	private Table createBankingPaymentInfo() throws Exception {
		...
		paragraph9.setWidthPercent(100).setMargin(0).setMarginTop(2).setPadding(0).setPaddingLeft(10).setFixedLeading(8);
