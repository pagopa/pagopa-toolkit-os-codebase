  ...
  public static void main(String[] args) {
      ...
      public void actionPerformed(ActionEvent e) {
        ...
        if (returnValue == JFileChooser.APPROVE_OPTION) {
          ...
          try {
            ...
            JOptionPane.showMessageDialog(jFrame, "Si è verificato un errore durante il download del template",
    ...
    btnConfirm.addActionListener(new ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
        ...
        try {
          readerStatus = readerProcessFile.processCsvFile(txtCsvFile.getText(), txtOutputFolder.getText(),
              txtLogo.getText());
        ...
        if (readerStatus != null) {
          switch (readerStatus) {
            case OK:
              JOptionPane.showMessageDialog(jFrame, "Il caricamento è stato completato con successo", MESSAGE_TITLE,
                  JOptionPane.INFORMATION_MESSAGE);
              break;
            case WARNING:
              JOptionPane
                  .showMessageDialog(jFrame,
                      "Il caricamento è stato completato con successo, ma alcune posizioni non sono state caricate.\n"
                          + "Consultare l’esito per ulteriori informazioni",
                      MESSAGE_TITLE, JOptionPane.WARNING_MESSAGE);
              break;
            case KO:
              JOptionPane.showMessageDialog(jFrame,
                  "Il caricamento è terminato in errore. Ripetere nuovamente l’operazione", MESSAGE_TITLE,
